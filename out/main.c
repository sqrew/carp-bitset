...
typedef struct {
    int* sum_MINUS_ptr;
} _Lambda_NAKED_LAMBDA_244_env_ty;
...
// Depth 107
typedef String(*Fn__Array__Uint64_MUL__String)(Array__Uint64*);

// Depth 107
typedef Uint64(*Fn__Array__Uint64_MUL__Uint64)(Array__Uint64*);
...
// Depth 109
typedef BitSet(*Fn__Array__Uint64_BitSet)(Array__Uint64);
...
// Depth 109
typedef Array__Uint64*(*Fn__BitSet_MUL__Array__Uint64_MUL_)(BitSet*);

// Depth 109
typedef void(*Fn__BitSet_MUL__Array__Uint64_void)(BitSet*, Array__Uint64);

// Depth 109
typedef void(*Fn__BitSet_MUL__BitSet_MUL__void)(BitSet*, BitSet*);

// Depth 109
typedef String(*Fn__BitSet_MUL__String)(BitSet*);

// Depth 109
typedef int(*Fn__BitSet_MUL__int)(BitSet*);

// Depth 109
typedef bool(*Fn__BitSet_MUL__int_bool)(BitSet*, int);

// Depth 109
typedef void(*Fn__BitSet_MUL__int_void)(BitSet*, int);

// Depth 109
typedef void(*Fn__BitSet_MUL__void)(BitSet*);
...
// Depth 109
typedef void(*Fn__Fn__int_MUL__void_MUL__BitSet_MUL__void)(Lambda*, BitSet*);
...
// Depth 505
typedef Array__Uint64(*Fn__LambdaEnv_Array__Uint64_Array__Uint64)(LambdaEnv, Array__Uint64);
...
// Depth 500
void _Lambda_NAKED_LAMBDA_244_env(_Lambda_NAKED_LAMBDA_244_env_ty* _env, int* idx);

// Depth 500
_Lambda_NAKED_LAMBDA_244_env_ty* _Lambda_NAKED_LAMBDA_244_env_ty_copy(_Lambda_NAKED_LAMBDA_244_env_ty* pRef);

// Depth 500
void _Lambda_NAKED_LAMBDA_244_env_ty_delete(_Lambda_NAKED_LAMBDA_244_env_ty* p);
...
// Depth 500
void Array_aset_BANG___Uint64 (Array *aRef, int n, Uint64 newValue);
...
// Depth 500
Uint64 Array_pop_MINUS_back_BANG___Uint64(Array *aRef);

// Depth 500
Array__Char Array_prefix__Array__Char(Array__Char* xs, int end_MINUS_index);

// Depth 500
String Array_prn__Uint64(Array__Uint64* x);
...
// Depth 500
String Array_str__Uint64 (Array* a);
...
// Depth 500
void BitSet_add_BANG_(BitSet* bs, int id);

// Depth 500
void BitSet_clear_BANG_(BitSet* bs);

// Depth 500
bool BitSet_contains_QMARK_(BitSet* bs, int id);

// Depth 500
BitSet BitSet_copy(BitSet* pRef);

// Depth 500
int BitSet_count(BitSet* bs);

// Depth 500
void BitSet_delete(BitSet p);

// Depth 500
void BitSet_difference_BANG_(BitSet* bs, BitSet* other);

// Depth 500
void BitSet_ensure_MINUS_capacity_BANG_(BitSet* bs, int word_MINUS_idx);

// Depth 500
void BitSet_for_MINUS_each_MINUS_set(Lambda* f, BitSet* bs);

// Depth 500
BitSet BitSet_init(Array__Uint64 words);

// Depth 500
void BitSet_intersection_BANG_(BitSet* bs, BitSet* other);

// Depth 500
BitSet BitSet_new();

// Depth 500
String BitSet_prn(BitSet *p);

// Depth 500
void BitSet_remove_BANG_(BitSet* bs, int id);

// Depth 500
BitSet BitSet_set_MINUS_words(BitSet p, Array__Uint64 newValue);

// Depth 500
void BitSet_set_MINUS_words_BANG_(BitSet* pRef, Array__Uint64 newValue);

// Depth 500
void BitSet_shrink_MINUS_to_MINUS_fit_BANG_(BitSet* bs);

// Depth 500
String BitSet_str(BitSet* bs);

// Depth 500
void BitSet_symmetric_MINUS_difference_BANG_(BitSet* bs, BitSet* other);

// Depth 500
void BitSet_toggle_BANG_(BitSet* bs, int id);

// Depth 500
void BitSet_union_BANG_(BitSet* bs, BitSet* other);

// Depth 500
BitSet BitSet_update_MINUS_words(BitSet p, Lambda *updater);

// Depth 500
BitSet BitSet_with_MINUS_capacity(int n);

// Depth 500
Array__Uint64* BitSet_words(BitSet* p);
...
Uint64 Array_pop_MINUS_back_BANG___Uint64(Array *aRef) { 
  Uint64 ret;
  assert(aRef->len > 0);
  ret = ((Uint64*)aRef->data)[aRef->len - 1];
  aRef->len--;
  return ret;
}
...
String Array_str__Uint64 (Array* a) {
  ...
  for(int i = 0; i < a->len; i++) {
    temp = Uint64_prn(((Uint64*)a->data)[i]);
...
void BitSet_add_BANG_(BitSet* bs, int id) {
    /* let */ {
        int _10 = Int__DIV_(id, 64);
        int word_MINUS_idx = _10;
        int _15 = Int_mod(id, 64);
        int bit_MINUS_offset = _15;
        Long _20 = Long_from_MINUS_int(bit_MINUS_offset);
        Uint64 _21 = Uint64_from_MINUS_long(_20);
        Uint64 shift = _21;
        Uint64 _26 = Uint64_from_MINUS_long(1l);
        Uint64 _28 = Uint64_bit_MINUS_shift_MINUS_left(_26, shift);
        Uint64 mask = _28;
        BitSet_ensure_MINUS_capacity_BANG_(bs, word_MINUS_idx);
        /* let */ {
            Array__Uint64* _39 = BitSet_words(bs);
            Array__Uint64* words = _39;
            Uint64* _44 = Array_unsafe_MINUS_nth__Uint64(words, word_MINUS_idx);
            Uint64* word = _44;
            Uint64 _52 = Uint64_copy(word);
            Uint64 _54 = Uint64_bit_MINUS_or(_52, mask);
            Array_aset_BANG___Uint64(words, word_MINUS_idx, _54);
        }
    }
}
...
void BitSet_clear_BANG_(BitSet* bs) {
    /* let */ {
        Array__Uint64* _8 = BitSet_words(bs);
        Array__Uint64* words = _8;
        int _12 = Array_length__Uint64(words);
        int len = _12;
        /* let */ {
            int i = 0;
            bool _22 = Int__LT_(i, len);
            bool _38 = _22;
            while (_38) {
                Uint64 _28 = Uint64_zero();
                Array_aset_BANG___Uint64(words, i, _28);
...
bool BitSet_contains_QMARK_(BitSet* bs, int id) {
    ...
    /* let */ {
        ...
        Uint64 _28 = Uint64_bit_MINUS_shift_MINUS_left(_26, shift);
        Uint64 mask = _28;
        Array__Uint64* _32 = BitSet_words(bs);
        Array__Uint64* words = _32;
        bool _66;
        int _39 = Array_length__Uint64(words);
        bool _40 = Int__LT_(word_MINUS_idx, _39);
        if (_40) {
            bool _61;
            /* let */ {
                Uint64* _48 = Array_unsafe_MINUS_nth__Uint64(words, word_MINUS_idx);
                Uint64 _49 = Uint64_copy(_48);
                Uint64 word = _49;
                Uint64 _56 = Uint64_bit_MINUS_and(word, mask);
                Uint64 _58 = Uint64_zero();
                bool _59 = Uint64__EQ_(_56, _58);
                bool _60 = not(_59);
                _61 = _60;
            }
            bool _62 = _61;
...
BitSet BitSet_copy(BitSet* pRef) {
    BitSet copy = *pRef;
    copy.words = Array_copy__Uint64(&(pRef->words));
    return copy;
}
...
int BitSet_count(BitSet* bs) {
    ...
    /* let */ {
        ...
        /* let */ {
            int i = 0;
            bool _25 = Int__LT_(i, len);
            bool _137 = _25;
            while (_137) {
                /* let */ {
                    Uint64* _33 = Array_unsafe_MINUS_nth__Uint64(words, i);
                    Uint64 _34 = Uint64_copy(_33);
                    Uint64 w = _34;
                    Uint64 _40 = Uint64_zero();
                    bool _41 = Uint64__EQ_(w, _40);
                    if (_41) {
                        /* () */
                    } else {
                        /* let */ {
                            Uint64 v1 = w;
                            Uint64 _57 = Uint64_from_MINUS_long(1l);
                            Uint64 _58 = Uint64_bit_MINUS_shift_MINUS_right(v1, _57);
                            Uint64 _61 = Uint64_from_MINUS_long(6148914691236517205l);
                            Uint64 _62 = Uint64_bit_MINUS_and(_58, _61);
                            Uint64 _63 = Uint64__MINUS_(v1, _62);
                            Uint64 v2 = _63;
                            Uint64 _70 = Uint64_from_MINUS_long(3689348814741910323l);
                            Uint64 _71 = Uint64_bit_MINUS_and(v2, _70);
                            Uint64 _77 = Uint64_from_MINUS_long(2l);
                            Uint64 _78 = Uint64_bit_MINUS_shift_MINUS_right(v2, _77);
                            Uint64 _81 = Uint64_from_MINUS_long(3689348814741910323l);
                            Uint64 _82 = Uint64_bit_MINUS_and(_78, _81);
                            Uint64 _83 = Uint64__PLUS_(_71, _82);
                            Uint64 v3 = _83;
                            Uint64 _92 = Uint64_from_MINUS_long(4l);
                            Uint64 _93 = Uint64_bit_MINUS_shift_MINUS_right(v3, _92);
                            Uint64 _94 = Uint64__PLUS_(v3, _93);
                            Uint64 _97 = Uint64_from_MINUS_long(1085102592571150095l);
                            Uint64 _98 = Uint64_bit_MINUS_and(_94, _97);
                            Uint64 v4 = _98;
                            Uint64 _104 = Uint64_from_MINUS_long(72340172838076673l);
                            Uint64 _105 = Uint64__MUL_(v4, _104);
                            Uint64 v5 = _105;
                            Uint64 _113 = Uint64_from_MINUS_long(56l);
                            Uint64 _114 = Uint64_bit_MINUS_shift_MINUS_right(v5, _113);
                            Long _115 = Uint64_to_MINUS_long(_114);
                            int _116 = Long_to_MINUS_int(_115);
                            int c = _116;
                            int _123 = Int__PLUS_(total, c);
                            total = _123;  // Int = Int
                        }
                    }
                }
                int _134 = Int__PLUS_(i, 1);
                i = _134;  // Int = Int
                bool _25 = Int__LT_(i, len);
                _137 = _25;
            }
...
void BitSet_delete(BitSet p) {
    Array_delete__Uint64(p.words);
}

void BitSet_difference_BANG_(BitSet* bs, BitSet* other) {
    /* let */ {
        Array__Uint64* _9 = BitSet_words(bs);
        Array__Uint64* words = _9;
        int _13 = Array_length__Uint64(words);
        int len = _13;
        Array__Uint64* _17 = BitSet_words(other);
        Array__Uint64* other_MINUS_words = _17;
        int _21 = Array_length__Uint64(other_MINUS_words);
        int other_MINUS_len = _21;
        /* let */ {
            int i = 0;
            int _41;
            bool _34 = Int__LT_(len, other_MINUS_len);
            if (_34) {
                int _37 = len;
                _41 = _37;
            } else {
                int _40 = other_MINUS_len;
                _41 = _40;
            }
            bool _42 = Int__LT_(i, _41);
            bool _79 = _42;
            while (_79) {
                /* let */ {
                    Uint64* _50 = Array_unsafe_MINUS_nth__Uint64(words, i);
                    Uint64 _51 = Uint64_copy(_50);
                    Uint64 w1 = _51;
                    Uint64* _57 = Array_unsafe_MINUS_nth__Uint64(other_MINUS_words, i);
                    Uint64 _58 = Uint64_copy(_57);
                    Uint64 w2 = _58;
                    Uint64 _67 = Uint64_bit_MINUS_not(w2);
                    Uint64 _68 = Uint64_bit_MINUS_and(w1, _67);
                    Array_aset_BANG___Uint64(words, i, _68);
                }
...
void BitSet_ensure_MINUS_capacity_BANG_(BitSet* bs, int word_MINUS_idx) {
    /* let */ {
        ...
        int _13 = Array_length__Uint64(words);
        int current = _13;
        bool _19 = _GT__EQ___int(word_MINUS_idx, current);
        if (_19) {
            /* let */ {
                int i = current;
                int _30 = Int_inc(word_MINUS_idx);
                bool _31 = Int__LT_(i, _30);
                bool _46 = _31;
                while (_46) {
                    Uint64 _36 = Uint64_zero();
                    Array_push_MINUS_back_BANG___Uint64(words, _36);
...
void BitSet_for_MINUS_each_MINUS_set(Lambda* f, BitSet* bs) {
    /* let */ {
        ...
        /* let */ {
            ...
            while (_124) {
                /* let */ {
                    Uint64* _31 = Array_unsafe_MINUS_nth__Uint64(words, i);
                    Uint64 _32 = Uint64_copy(_31);
                    Uint64 w = _32;
                    Uint64 _38 = Uint64_zero();
                    bool _39 = Uint64__EQ_(w, _38);
                    if (_39) {
                        /* () */
                    } else {
                        /* let */ {
                            int b = 0;
                            bool _52 = Int__LT_(b, 64);
                            bool _111 = _52;
                            while (_111) {
                                /* let */ {
                                    Long _59 = Long_from_MINUS_int(b);
                                    Uint64 _60 = Uint64_from_MINUS_long(_59);
                                    Uint64 shift = _60;
                                    Uint64 _65 = Uint64_from_MINUS_long(1l);
                                    Uint64 _67 = Uint64_bit_MINUS_shift_MINUS_left(_65, shift);
                                    Uint64 mask = _67;
                                    Uint64 _74 = Uint64_bit_MINUS_and(w, mask);
                                    Uint64 _76 = Uint64_zero();
                                    bool _77 = Uint64__EQ_(_74, _76);
                                    if (_77) {
                                        /* () */
                                    } else {
                                        /* let */ {
                                            int _88 = Int__MUL_(i, 64);
                                            int _90 = Int__PLUS_(_88, b);
                                            int idx = _90;
                                            int* _97 = &idx; // ref
                                            (*f).env ? ((void(*)(LambdaEnv, int*))(*f).callback)((*f).env, _97) : ((void(*)(int*))(*f).callback)(_97);
                                        }
                                    }
                                }
                                int _108 = Int__PLUS_(b, 1);
                                b = _108;  // Int = Int
                                bool _52 = Int__LT_(b, 64);
                                _111 = _52;
                            }
...
void BitSet_intersection_BANG_(BitSet* bs, BitSet* other) {
    /* let */ {
        ...
        /* let */ {
            int i = 0;
            bool _31 = Int__LT_(i, len);
            bool _78 = _31;
            while (_78) {
                /* let */ {
                    Uint64* _39 = Array_unsafe_MINUS_nth__Uint64(words, i);
                    Uint64 _40 = Uint64_copy(_39);
                    Uint64 w1 = _40;
                    Uint64 _59;
                    bool _46 = Int__LT_(i, other_MINUS_len);
                    if (_46) {
                        Uint64* _52 = Array_unsafe_MINUS_nth__Uint64(other_MINUS_words, i);
                        Uint64 _53 = Uint64_copy(_52);
                        Uint64 _54 = _53;
                        _59 = _54;
                    } else {
                        Uint64 _57 = Uint64_zero();
                        Uint64 _58 = _57;
                        _59 = _58;
                    }
                    Uint64 w2 = _59;
                    Uint64 _67 = Uint64_bit_MINUS_and(w1, w2);
                    Array_aset_BANG___Uint64(words, i, _67);
                }
...
BitSet BitSet_new() {
    Array _4 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(Uint64) * 0) };
    BitSet _5 = BitSet_init(_4);
    return _5;
}
...
String BitSet_prn(BitSet *p) {
  ...
  int size = snprintf(NULL, 0, "(%s )", "BitSet");
  temp = Array_prn__Uint64(&p->words); 
  size += snprintf(NULL, 0, "%s ", temp);
  ...
  sprintf(bufferPtr, "(%s ", "BitSet");
  bufferPtr += strlen("BitSet") + 2;
...
void BitSet_remove_BANG_(BitSet* bs, int id) {
    /* let */ {
        ...
        Uint64 _21 = Uint64_from_MINUS_long(_20);
        Uint64 shift = _21;
        Uint64 _27 = Uint64_from_MINUS_long(1l);
        Uint64 _29 = Uint64_bit_MINUS_shift_MINUS_left(_27, shift);
        Uint64 _30 = Uint64_bit_MINUS_not(_29);
        Uint64 mask = _30;
        Array__Uint64* _34 = BitSet_words(bs);
        Array__Uint64* words = _34;
        int _41 = Array_length__Uint64(words);
        bool _42 = Int__LT_(word_MINUS_idx, _41);
        if (_42) {
            /* let */ {
                Uint64* _49 = Array_unsafe_MINUS_nth__Uint64(words, word_MINUS_idx);
                Uint64* word = _49;
                Uint64 _57 = Uint64_copy(word);
                Uint64 _59 = Uint64_bit_MINUS_and(_57, mask);
                Array_aset_BANG___Uint64(words, word_MINUS_idx, _59);
            }
        } else {
            /* () */
        }
...
void BitSet_set_MINUS_words_BANG_(BitSet* pRef, Array__Uint64 newValue) {
    Array_delete__Uint64(pRef->words);
    pRef->words = newValue;
}
...
void BitSet_shrink_MINUS_to_MINUS_fit_BANG_(BitSet* bs) {
    /* let */ {
        ...
        int _12 = Array_length__Uint64(words);
        int len = _12;
        int last_MINUS_idx = -1;
        /* let */ {
            int _21 = Int_dec(len);
            int i = _21;
            bool _27 = Int__GT_(i, -1);
            bool _60 = _27;
            while (_60) {
                Uint64* _35 = Array_unsafe_MINUS_nth__Uint64(words, i);
                Uint64 _36 = Uint64_copy(_35);
                Uint64 _38 = Uint64_zero();
                bool _39 = Uint64__EQ_(_36, _38);
                if (_39) {
                    /* () */
                } else {
                    last_MINUS_idx = i;  // Int = Int
                    break;
                    // Unreachable:
                }
        ...
        bool _66 = Int__EQ_(last_MINUS_idx, -1);
        if (_66) {
            Array _70 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(Uint64) * 0) };
            BitSet_set_MINUS_words_BANG_(bs, _70);
        } else {
            Array__Uint64* _79 = BitSet_words(bs);
            int _80 = Array_length__Uint64(_79);
            int _83 = Int_inc(last_MINUS_idx);
            bool _84 = Int__GT_(_80, _83);
            bool _95 = _84;
            while (_95) {
                /* let */ {
                    Array__Uint64* _90 = BitSet_words(bs);
                    Uint64 _91 = Array_pop_MINUS_back_BANG___Uint64(_90);
                    Uint64 _ = _91;
                    /* () */
                }
                Array__Uint64* _79 = BitSet_words(bs);
...
String BitSet_str(BitSet* bs) {
    static String _9 = "BitSet(count: ";
    String *_9_ref = &_9;
    String _10 = String_str(_9_ref);
    String* _11 = &_10; // ref
    int _19 = BitSet_count(bs);
    String _20 = Int_str(_19);
    String _21 = StringCopy_str(_20);
    String* _22 = &_21; // ref
    static String _27 = ", words: ";
    String *_27_ref = &_27;
    String _28 = String_str(_27_ref);
    String* _29 = &_28; // ref
    Array__Uint64* _38 = BitSet_words(bs);
    int _39 = Array_length__Uint64(_38);
    String _40 = Int_str(_39);
    String _41 = StringCopy_str(_40);
    String* _42 = &_41; // ref
    static String _45 = ")";
    String *_45_ref = &_45;
    String _46 = String_str(_45_ref);
    String* _47 = &_46; // ref
    String _48 = String_append(_42, _47);
    String* _49 = &_48; // ref
    String _50 = String_append(_29, _49);
    String* _51 = &_50; // ref
    String _52 = String_append(_22, _51);
    String* _53 = &_52; // ref
    String _54 = String_append(_11, _53);
    String* _55 = &_54; // ref
    String _56 = String_copy(_55);
    String_delete(_10);
    String_delete(_21);
    String_delete(_28);
    String_delete(_41);
...
void BitSet_symmetric_MINUS_difference_BANG_(BitSet* bs, BitSet* other) {
    /* let */ {
        Array__Uint64* _9 = BitSet_words(other);
        Array__Uint64* other_MINUS_words = _9;
        int _13 = Array_length__Uint64(other_MINUS_words);
        int other_MINUS_len = _13;
        int _20 = Int_dec(other_MINUS_len);
        BitSet_ensure_MINUS_capacity_BANG_(bs, _20);
        /* let */ {
            Array__Uint64* _26 = BitSet_words(bs);
            Array__Uint64* words = _26;
            /* let */ {
                int i = 0;
                bool _36 = Int__LT_(i, other_MINUS_len);
                bool _71 = _36;
                while (_71) {
                    /* let */ {
                        Uint64* _44 = Array_unsafe_MINUS_nth__Uint64(words, i);
                        Uint64 _45 = Uint64_copy(_44);
                        Uint64 w1 = _45;
                        Uint64* _51 = Array_unsafe_MINUS_nth__Uint64(other_MINUS_words, i);
                        Uint64 _52 = Uint64_copy(_51);
                        Uint64 w2 = _52;
                        Uint64 _60 = Uint64_bit_MINUS_xor(w1, w2);
                        Array_aset_BANG___Uint64(words, i, _60);
                    }
                    int _68 = Int__PLUS_(i, 1);
                    i = _68;  // Int = Int
                    bool _36 = Int__LT_(i, other_MINUS_len);
                    _71 = _36;
                }
...
void BitSet_toggle_BANG_(BitSet* bs, int id) {
    /* let */ {
        ...
        /* let */ {
            ...
            Uint64* word = _44;
            Uint64 _52 = Uint64_copy(word);
            Uint64 _54 = Uint64_bit_MINUS_xor(_52, mask);
            Array_aset_BANG___Uint64(words, word_MINUS_idx, _54);
        }
    }
}
            ...
            /* let */ {
                ...
                while (_71) {
                    /* let */ {
                        ...
                        Uint64 _52 = Uint64_copy(_51);
                        Uint64 w2 = _52;
                        Uint64 _60 = Uint64_bit_MINUS_or(w1, w2);
                        Array_aset_BANG___Uint64(words, i, _60);
                    }
                    int _68 = Int__PLUS_(i, 1);
                    i = _68;  // Int = Int
...
BitSet BitSet_update_MINUS_words(BitSet p, Lambda *updater) {
    p.words = (*updater).env ? ((Fn__LambdaEnv_Array__Uint64_Array__Uint64)(*updater).callback)((*updater).env, p.words) : ((Fn__Array__Uint64_Array__Uint64)(*updater).callback)(p.words);
    return p;
}
...
BitSet BitSet_with_MINUS_capacity(int n) {
    BitSet _19;
    /* let */ {
        int _11 = Int__DIV_(n, 64);
        int _12 = Int__PLUS_(1, _11);
        int num_MINUS_words = _12;
        Array__Uint64 _17 = Array_allocate__Uint64(num_MINUS_words);
        BitSet _18 = BitSet_init(_17);
        _19 = _18;
    }
    return _19;
}

Array__Uint64* BitSet_words(BitSet* p) { return (&(p->words)); }
...
void _Lambda_NAKED_LAMBDA_244_env(_Lambda_NAKED_LAMBDA_244_env_ty* _env, int* idx) {
    int _238 = Pointer_to_MINUS_value__int(_env->sum_MINUS_ptr);
    int _241 = Int_copy(idx);
    int _242 = Int__PLUS_(_238, _241);
    Pointer_set__int(_env->sum_MINUS_ptr, _242);
}

_Lambda_NAKED_LAMBDA_244_env_ty* _Lambda_NAKED_LAMBDA_244_env_ty_copy(_Lambda_NAKED_LAMBDA_244_env_ty* pRef) {
    _Lambda_NAKED_LAMBDA_244_env_ty* copy = CARP_MALLOC(sizeof(*pRef));
    *copy = *pRef;
    /* Ignore non-managed member 'sum_MINUS_ptr' : (Ptr Int) */
    return copy;
}
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        ...
        TestState* bitset_MINUS_test = _10;
        TestState _667;
        /* let */ {
            BitSet _19 = BitSet_new();
            BitSet bs = _19;
            TestState _24 = Test_State_init(0, 0);
            TestState state = _24;
            BitSet* _30 = &bs; // ref
            BitSet_add_BANG_(_30, 10);
            BitSet* _36 = &bs; // ref
            BitSet_add_BANG_(_36, 100);
            TestState* _44 = &state; // ref
            BitSet* _48 = &bs; // ref
            bool _50 = BitSet_contains_QMARK_(_48, 10);
            static String _51 = "Bit 10 is set";
            String *_51_ref = &_51;
            TestState _52 = Test_assert_MINUS_true__String(_44, _50, _51_ref);
            Test_State_delete(state);
            state = _52;  // Test.State = Test.State
            TestState* _59 = &state; // ref
            BitSet* _63 = &bs; // ref
            bool _65 = BitSet_contains_QMARK_(_63, 100);
            static String _66 = "Bit 100 is set";
            String *_66_ref = &_66;
            TestState _67 = Test_assert_MINUS_true__String(_59, _65, _66_ref);
            Test_State_delete(state);
            state = _67;  // Test.State = Test.State
            TestState* _74 = &state; // ref
            BitSet* _78 = &bs; // ref
            bool _80 = BitSet_contains_QMARK_(_78, 50);
            static String _81 = "Bit 50 is not set";
            String *_81_ref = &_81;
            TestState _82 = Test_assert_MINUS_false__String(_74, _80, _81_ref);
            Test_State_delete(state);
            state = _82;  // Test.State = Test.State
            TestState* _89 = &state; // ref
            BitSet* _94 = &bs; // ref
            int _95 = BitSet_count(_94);
            static String _96 = "Count is 2";
            String *_96_ref = &_96;
            TestState _97 = Test_assert_MINUS_equal__int_String(_89, 2, _95, _96_ref);
            Test_State_delete(state);
            state = _97;  // Test.State = Test.State
            BitSet* _102 = &bs; // ref
            BitSet_toggle_BANG_(_102, 50);
            TestState* _110 = &state; // ref
            BitSet* _114 = &bs; // ref
            bool _116 = BitSet_contains_QMARK_(_114, 50);
            static String _117 = "Bit 50 set after toggle";
            String *_117_ref = &_117;
            TestState _118 = Test_assert_MINUS_true__String(_110, _116, _117_ref);
            Test_State_delete(state);
            state = _118;  // Test.State = Test.State
            BitSet* _123 = &bs; // ref
            BitSet_toggle_BANG_(_123, 10);
            TestState* _131 = &state; // ref
            BitSet* _135 = &bs; // ref
            bool _137 = BitSet_contains_QMARK_(_135, 10);
            static String _138 = "Bit 10 unset after toggle";
            String *_138_ref = &_138;
            TestState _139 = Test_assert_MINUS_false__String(_131, _137, _138_ref);
            Test_State_delete(state);
            state = _139;  // Test.State = Test.State
            TestState* _146 = &state; // ref
            BitSet* _151 = &bs; // ref
            int _152 = BitSet_count(_151);
            static String _153 = "Count is still 2";
            String *_153_ref = &_153;
            TestState _154 = Test_assert_MINUS_equal__int_String(_146, 2, _152, _153_ref);
            Test_State_delete(state);
            state = _154;  // Test.State = Test.State
            BitSet* _159 = &bs; // ref
            BitSet_remove_BANG_(_159, 100);
            TestState* _167 = &state; // ref
            BitSet* _171 = &bs; // ref
            bool _173 = BitSet_contains_QMARK_(_171, 100);
            static String _174 = "Bit 100 removed";
            String *_174_ref = &_174;
            TestState _175 = Test_assert_MINUS_false__String(_167, _173, _174_ref);
            Test_State_delete(state);
            state = _175;  // Test.State = Test.State
            TestState* _182 = &state; // ref
            BitSet* _187 = &bs; // ref
            int _188 = BitSet_count(_187);
            static String _189 = "Count is 1";
            String *_189_ref = &_189;
            TestState _190 = Test_assert_MINUS_equal__int_String(_182, 1, _188, _189_ref);
            Test_State_delete(state);
            state = _190;  // Test.State = Test.State
            /* let */ {
                int sum = 0;
                BitSet* _200 = &bs; // ref
                BitSet_clear_BANG_(_200);
                BitSet* _205 = &bs; // ref
                BitSet_add_BANG_(_205, 1);
                BitSet* _211 = &bs; // ref
                BitSet_add_BANG_(_211, 3);
                BitSet* _217 = &bs; // ref
                BitSet_add_BANG_(_217, 5);
                /* let */ {
                    int* _225 = &sum; // ref
                    int* _226 = Pointer_address__int(_225);
                    int* sum_MINUS_ptr = _226;
                    // This lambda captures 1 variables: sum-ptr
                    _Lambda_NAKED_LAMBDA_244_env_ty *_244_env = CARP_MALLOC(sizeof(_Lambda_NAKED_LAMBDA_244_env_ty));
                    _244_env->sum_MINUS_ptr = sum_MINUS_ptr;
                    Lambda _244 = {
                      .callback = (void*)_Lambda_NAKED_LAMBDA_244_env,
                      .env = _244_env,
                      .delete = (void*)_Lambda_NAKED_LAMBDA_244_env_ty_delete,
                      .copy = (void*)_Lambda_NAKED_LAMBDA_244_env_ty_copy
                    };
                    Lambda* _245 = &_244; // ref
                    BitSet* _248 = &bs; // ref
                    BitSet_for_MINUS_each_MINUS_set(_245, _248);
                    Function_delete__int_MUL__void(_244);
                }
                TestState* _256 = &state; // ref
                static String _259 = "for-each-set works";
                String *_259_ref = &_259;
                TestState _260 = Test_assert_MINUS_equal__int_String(_256, 9, sum, _259_ref);
                Test_State_delete(state);
                state = _260;  // Test.State = Test.State
            }
            /* let */ {
                BitSet _267 = BitSet_new();
                BitSet bs1 = _267;
                BitSet _270 = BitSet_new();
                BitSet bs2 = _270;
                BitSet* _276 = &bs1; // ref
                BitSet_add_BANG_(_276, 1);
                BitSet* _282 = &bs1; // ref
                BitSet_add_BANG_(_282, 2);
                BitSet* _288 = &bs2; // ref
                BitSet_add_BANG_(_288, 2);
                BitSet* _294 = &bs2; // ref
                BitSet_add_BANG_(_294, 3);
                /* let */ {
                    BitSet _300 = BitSet_new();
                    BitSet u = _300;
                    BitSet* _306 = &u; // ref
                    BitSet* _309 = &bs1; // ref
                    BitSet_union_BANG_(_306, _309);
                    BitSet* _314 = &u; // ref
                    BitSet* _317 = &bs2; // ref
                    BitSet_union_BANG_(_314, _317);
                    TestState* _324 = &state; // ref
                    BitSet* _329 = &u; // ref
                    int _330 = BitSet_count(_329);
                    static String _331 = "Union works";
                    String *_331_ref = &_331;
                    TestState _332 = Test_assert_MINUS_equal__int_String(_324, 3, _330, _331_ref);
                    Test_State_delete(state);
                    state = _332;  // Test.State = Test.State
                    TestState* _339 = &state; // ref
                    BitSet* _343 = &u; // ref
                    bool _345 = BitSet_contains_QMARK_(_343, 1);
                    static String _346 = "Union contains 1";
                    String *_346_ref = &_346;
                    TestState _347 = Test_assert_MINUS_true__String(_339, _345, _346_ref);
                    Test_State_delete(state);
                    state = _347;  // Test.State = Test.State
                    TestState* _354 = &state; // ref
                    BitSet* _358 = &u; // ref
                    bool _360 = BitSet_contains_QMARK_(_358, 2);
                    static String _361 = "Union contains 2";
                    String *_361_ref = &_361;
                    TestState _362 = Test_assert_MINUS_true__String(_354, _360, _361_ref);
                    Test_State_delete(state);
                    state = _362;  // Test.State = Test.State
                    TestState* _369 = &state; // ref
                    BitSet* _373 = &u; // ref
                    bool _375 = BitSet_contains_QMARK_(_373, 3);
                    static String _376 = "Union contains 3";
                    String *_376_ref = &_376;
                    TestState _377 = Test_assert_MINUS_true__String(_369, _375, _376_ref);
                    Test_State_delete(state);
                    state = _377;  // Test.State = Test.State
                    BitSet_delete(u);
                }
                /* let */ {
                    BitSet _384 = BitSet_new();
                    BitSet i = _384;
                    BitSet* _390 = &i; // ref
                    BitSet* _393 = &bs1; // ref
                    BitSet_union_BANG_(_390, _393);
                    BitSet* _398 = &i; // ref
                    BitSet* _401 = &bs2; // ref
                    BitSet_intersection_BANG_(_398, _401);
                    TestState* _408 = &state; // ref
                    BitSet* _413 = &i; // ref
                    int _414 = BitSet_count(_413);
                    static String _415 = "Intersection works";
                    String *_415_ref = &_415;
                    TestState _416 = Test_assert_MINUS_equal__int_String(_408, 1, _414, _415_ref);
                    Test_State_delete(state);
                    state = _416;  // Test.State = Test.State
                    TestState* _423 = &state; // ref
                    BitSet* _427 = &i; // ref
                    bool _429 = BitSet_contains_QMARK_(_427, 2);
                    static String _430 = "Intersection contains 2";
                    String *_430_ref = &_430;
                    TestState _431 = Test_assert_MINUS_true__String(_423, _429, _430_ref);
                    Test_State_delete(state);
                    state = _431;  // Test.State = Test.State
                    TestState* _438 = &state; // ref
                    BitSet* _442 = &i; // ref
                    bool _444 = BitSet_contains_QMARK_(_442, 1);
                    static String _445 = "Intersection doesn't contain 1";
                    String *_445_ref = &_445;
                    TestState _446 = Test_assert_MINUS_false__String(_438, _444, _445_ref);
                    Test_State_delete(state);
                    state = _446;  // Test.State = Test.State
                    BitSet_delete(i);
                }
                /* let */ {
                    BitSet _453 = BitSet_new();
                    BitSet d = _453;
                    BitSet* _459 = &d; // ref
                    BitSet* _462 = &bs1; // ref
                    BitSet_union_BANG_(_459, _462);
                    BitSet* _467 = &d; // ref
                    BitSet* _470 = &bs2; // ref
                    BitSet_difference_BANG_(_467, _470);
                    TestState* _477 = &state; // ref
                    BitSet* _482 = &d; // ref
                    int _483 = BitSet_count(_482);
                    static String _484 = "Difference works";
                    String *_484_ref = &_484;
                    TestState _485 = Test_assert_MINUS_equal__int_String(_477, 1, _483, _484_ref);
                    Test_State_delete(state);
                    state = _485;  // Test.State = Test.State
                    TestState* _492 = &state; // ref
                    BitSet* _496 = &d; // ref
                    bool _498 = BitSet_contains_QMARK_(_496, 1);
                    static String _499 = "Difference contains 1";
                    String *_499_ref = &_499;
                    TestState _500 = Test_assert_MINUS_true__String(_492, _498, _499_ref);
                    Test_State_delete(state);
                    state = _500;  // Test.State = Test.State
                    TestState* _507 = &state; // ref
                    BitSet* _511 = &d; // ref
                    bool _513 = BitSet_contains_QMARK_(_511, 2);
                    static String _514 = "Difference doesn't contain 2";
                    String *_514_ref = &_514;
                    TestState _515 = Test_assert_MINUS_false__String(_507, _513, _514_ref);
                    Test_State_delete(state);
                    state = _515;  // Test.State = Test.State
                    BitSet_delete(d);
                }
                /* let */ {
                    BitSet _522 = BitSet_new();
                    BitSet sd = _522;
                    BitSet* _528 = &sd; // ref
                    BitSet* _531 = &bs1; // ref
                    BitSet_union_BANG_(_528, _531);
                    BitSet* _536 = &sd; // ref
                    BitSet* _539 = &bs2; // ref
                    BitSet_symmetric_MINUS_difference_BANG_(_536, _539);
                    TestState* _546 = &state; // ref
                    BitSet* _551 = &sd; // ref
                    int _552 = BitSet_count(_551);
                    static String _553 = "Symmetric Difference works";
                    String *_553_ref = &_553;
                    TestState _554 = Test_assert_MINUS_equal__int_String(_546, 2, _552, _553_ref);
                    Test_State_delete(state);
                    state = _554;  // Test.State = Test.State
                    TestState* _561 = &state; // ref
                    BitSet* _565 = &sd; // ref
                    bool _567 = BitSet_contains_QMARK_(_565, 1);
                    static String _568 = "SD contains 1";
                    String *_568_ref = &_568;
                    TestState _569 = Test_assert_MINUS_true__String(_561, _567, _568_ref);
                    Test_State_delete(state);
                    state = _569;  // Test.State = Test.State
                    TestState* _576 = &state; // ref
                    BitSet* _580 = &sd; // ref
                    bool _582 = BitSet_contains_QMARK_(_580, 2);
                    static String _583 = "SD doesn't contain 2";
                    String *_583_ref = &_583;
                    TestState _584 = Test_assert_MINUS_false__String(_576, _582, _583_ref);
                    Test_State_delete(state);
                    state = _584;  // Test.State = Test.State
                    TestState* _591 = &state; // ref
                    BitSet* _595 = &sd; // ref
                    bool _597 = BitSet_contains_QMARK_(_595, 3);
                    static String _598 = "SD contains 3";
                    String *_598_ref = &_598;
                    TestState _599 = Test_assert_MINUS_true__String(_591, _597, _598_ref);
                    Test_State_delete(state);
                    state = _599;  // Test.State = Test.State
                    BitSet_delete(sd);
                }
                BitSet_delete(bs1);
                BitSet_delete(bs2);
            ...
            BitSet* _609 = &bs; // ref
            BitSet_clear_BANG_(_609);
            BitSet* _614 = &bs; // ref
            BitSet_add_BANG_(_614, 1000);
            TestState* _622 = &state; // ref
            BitSet* _628 = &bs; // ref
            Array__Uint64* _629 = BitSet_words(_628);
            int _630 = Array_length__Uint64(_629);
            bool _632 = Int__GT_(_630, 10);
            static String _633 = "Words array is large";
            String *_633_ref = &_633;
            TestState _634 = Test_assert_MINUS_true__String(_622, _632, _633_ref);
            Test_State_delete(state);
            state = _634;  // Test.State = Test.State
            BitSet* _639 = &bs; // ref
            BitSet_remove_BANG_(_639, 1000);
            BitSet* _645 = &bs; // ref
            BitSet_shrink_MINUS_to_MINUS_fit_BANG_(_645);
            TestState* _652 = &state; // ref
            BitSet* _658 = &bs; // ref
            Array__Uint64* _659 = BitSet_words(_658);
            int _660 = Array_length__Uint64(_659);
            static String _661 = "Words array shrunk to 0 after clear";
            String *_661_ref = &_661;
            TestState _662 = Test_assert_MINUS_equal__int_String(_652, 0, _660, _661_ref);
            Test_State_delete(state);
            state = _662;  // Test.State = Test.State
            TestState _666 = state;
            _667 = _666;
            BitSet_delete(bs);
        }
        TestState* _668 = &_667; // ref
        bitset_MINUS_test = _668;  // (Ref Test.State r413) = (Ref Test.State r413)
        Test_print_MINUS_test_MINUS_results(bitset_MINUS_test);
        int* _676 = Test_State_failed(bitset_MINUS_test);
        int _677 = Int_copy(_676);
        int _678 = _677;
        _679 = _678;
        Test_State_delete(_667);
